"""
	Para lançar habilidade do Jogador 1 aperte { G H G H }
	Para lançar habilidade do Jogador 2 aperte { K L K L }
"""
#encoding=utf-8
...
def jogo(Z,info,mapa): #Z== VIDAS e PONTOS, info== PERSONAGENS, musica==Musica do Mapa, mapa==Qual a ser desenhado 
	TECLASP1=[]
	TECLASP2=[]
...
############ --- sequencia para habilidade --- ########
		if tempoP1>150:
			TECLASP1=[]
			
		if ("g" in teclas) and (TECLASP1==[]) and (contHAB_P1>MAXIMO_P1):	
			TECLASP1=['g']		
			tempoP1=0
		elif ("h" in teclas) and (TECLASP1==['g']) and (contHAB_P1>MAXIMO_P1):
			TECLASP1=['g','h']
			tempoP1=0
		elif ("g" in teclas) and (TECLASP1==['g','h']) and (contHAB_P1>MAXIMO_P1) and ("h" not in teclas):
			TECLASP1=['g','h','g']
			tempoP1=0
		elif ("h" in teclas) and (TECLASP1==['g','h','g']) and contHAB_P1>MAXIMO_P1 and ("g" not in teclas):
			HABILIDADE_P1=True	
			tempoP1=0
		...
		if ("k" in teclas) and (TECLASP2==[]) and (contHAB_P2>MAXIMO_P2):	
			TECLASP2=['k']		
			tempoP2=0
		elif ("l" in teclas) and (TECLASP2==['k']) and (contHAB_P2>MAXIMO_P2):
			TECLASP2=['k','l']
			tempoP2=0
		elif ("k" in teclas) and (TECLASP2==['k','l']) and (contHAB_P2>MAXIMO_P2) and ("l" not in teclas):
			TECLASP2=['k','l','k']
			tempoP2=0
		elif ("l" in teclas) and (TECLASP2==['k','l','k']) and (contHAB_P2>MAXIMO_P2) and ("k" not in teclas):
			HABILIDADE_P2=True	
			tempoP2=0
  ...
  while Z==4:   #FAZ AS TELAS DE SELEÇÃO VOLTAREM
		while Y==4:
		  if x2!=0:
		    ...
		    X = selecao(selecaoPersonagem)
		  Y = mapa(mapas,voltar) 
		  if Y==4:
		    x2=1   
		os.system("xset r on")  
		Z = opcoes(opcoesMenu,voltar)
		if Z==4:
		  x2=0
		  Y=4
